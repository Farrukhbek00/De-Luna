    ...
    <div class="site-section bg-light">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="hotel-room text-center">
                        <a href="{{ route('room_order') }}" class="d-block mb-0 thumbnail"><img src="images/room_1.jpg"
                                                                                                alt="Image"
                                                                                                class="img-fluid"></a>
                        <div class="hotel-room-body">
                ...
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="hotel-room text-center">
                        <a href="{{ route('room_order') }}" class="d-block mb-0 thumbnail"><img src="images/room_2.jpg"
                                                                                                alt="Image"
                                                                                                class="img-fluid"></a>
                        <div class="hotel-room-body">
                ...
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="hotel-room text-center">
                        <a href="{{ route('room_order') }}" class="d-block mb-0 thumbnail"><img src="images/room_3.jpg"
                                                                                                alt="Image"
                                                                                                class="img-fluid"></a>
                        <div class="hotel-room-body">
                ...
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="hotel-room text-center">
                        <a href="{{ route('room_order') }}" class="d-block mb-0 thumbnail"><img src="images/room_4.jpg"
                                                                                                alt="Image"
                                                                                                class="img-fluid"></a>
                        <div class="hotel-room-body">
                ...
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="hotel-room text-center">
                        <a href="{{ route('room_order') }}" class="d-block mb-0 thumbnail"><img src="images/room_5.jpg"
                                                                                                alt="Image"
                                                                                                class="img-fluid"></a>
                        <div class="hotel-room-body">
                ...
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="hotel-room text-center">
                        <a href="{{ route('room_order') }}" class="d-block mb-0 thumbnail"><img src="images/room_6.jpg"
                                                                                                alt="Image"
                                                                                                class="img-fluid"></a>
                        <div class="hotel-room-body">
                            <h3 class="heading mb-0"><a href="{{ route('room_order') }}">Single Room</a></h3>
